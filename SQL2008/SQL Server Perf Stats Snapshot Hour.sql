...
BEGIN
  PRINT ''
  PRINT '**** NOTE ****'
  PRINT '**** This script is for SQL Server 2008 and 2008 R2.  Errors are expected when run on earlier versions.'
  PRINT '**************'
  PRINT ''
END
ELSE 
BEGIN
  ...
  PRINT '[SERVER]_[INSTANCE]_SQL_2008_Perf_Stats_Snapshot_*.OUT'
  PRINT ''
END
